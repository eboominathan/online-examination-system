    ...
    <div class="modal-dialog " role="document">
        <form class="refreshFrm" id="addCourseFrm" method="post">
            <div class="modal-content myModal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Update ( <?php echo $selCourseRow['cou_name']; ?> )
                    </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                ...
                <div class="modal-body">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="question" class="form-control" placeholder="Input question"
                                autocomplete="off" required>
                        </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="choice_<?php echo $choice; ?>" class="form-control"
                                            placeholder="Input choice <?php echo $choice; ?>" autocomplete="off"
                                            required>
                                    </div>
                                    <div class="col-md-4">
                                        <label>Mark</label>
                                        <input type="number" name="mark_<?php echo $choice; ?>" class="form-control"
                                            placeholder="Mark for <?php echo $choice; ?>" autocomplete="off" required>
                                    </div>
                                    <div class="col-md-4">
                                        <label>Description</label>
                                        <input type="text" name="desc_<?php echo $choice; ?>" class="form-control"
                                            placeholder="Description for <?php echo $choice; ?>" autocomplete="off"
                                            required>
                                    </div>
                                </div>
                            </div>
